...
project = u'Biosecure DS2 Signature Global Features
 Database (Bob API)'
import time
...
from bob.db.biosecureds2signgf.driver import Interface
...
man_pages = [
    ('index', 'bob', u'Biosecure DS2 Signature Global Features Database (Bob API) Documentation', [u''], 1)
]
